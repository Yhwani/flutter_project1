        ...
        return Scaffold(
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      // 메모 고정 아이콘
                      leading: IconButton(
                        icon: Icon(memo.isPin
                            ? CupertinoIcons.pin_fill
                            : CupertinoIcons.pin),
                        onPressed: () {
                          memoService.pincheck(index: index);
                          print('$memo : pin 클릭 됨');
                        },
                      ),
                      ...
                      onTap: () async {
                        ...
                        memoService.nullData(
                            content: memo.content, index: index);
                      },
                    );
                  },
                ),
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () async {
              ...
              // 비어있으면 삭제
              int index = memoService.memoList.length - 1;
              memoService.nullData(
                  content: memoService.memoList[index].content, index: index);
            },
          ),
        );
      },
